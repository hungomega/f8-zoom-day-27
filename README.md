...
Khi gõ vào textarea code HTML, CSS thì bên preview ngay lập tức hiển thị kết quả. Gợi ý: bắt event `input` trên textarea sau đó cập nhật property `srcDoc` trên phần tử `iframe` bằng nội dung của textarea.
...
- Context menu có ít nhất 1 lựa chọn là **“Xóa code”**, nhấn vào sẽ xóa code của editor đi, preview cũng thay đổi tương ứng.
- Giao diện context menu tùy ý CSS.
